...
![image](https://user-images.githubusercontent.com/85272350/130167947-20c14b40-4694-4162-98e8-c396390854fa.png)
<br>단어가 어근 별로 구분되기 때문에 위의 '해','만','면','전','기'와 같이 구분되는 경우가 있습니다. 이는 stopword에 불용어 사전을 추가하는 것으로 해결할 수 있습니다. 앞의 '해'와 같은 경우 일반적인 연도를 뜻하는 해가 아닌 '해를 끼치다'와 같이 나쁜뜻으로 인식되어 부정 단어에 속하는 경우가 있습니다. 이는 감성사전에서 두 개의 해1와 해2를 구분해준다면 해결할 수 있을 것입니다. 
